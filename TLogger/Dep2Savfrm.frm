...
Private Sub Command1_Click()
    ...
    Else
        ...
        End If
        Mainfrm.Mainlst.AddItem Format(Date, "mm/dd/yyyy") & "     " & "Deposit To Savings       " & "     " & Text2 & "+      " & Text1 & "      " & Text3, 0
...
Private Sub Form_Load()
    center Me
    DoEvents
    SetFormTopmost Dep2Savfrm
    Dep2Savfrm.Height = 0
    For X = 1 To 1125
        Dep2Savfrm.Height = Dep2Savfrm.Height + 1
        center Me
        DoEvents
        If Dep2Savfrm.Visible <> True Then
            Dep2Savfrm.Visible = True
        End If
    Next X
    Text1.SetFocus
End Sub
