...
Private Sub Command1_Click()
    ...
    Else
        ...
        If Option1.Value = True Then
            Mainfrm.Mainlst.AddItem Format(Date, "mm/dd/yyyy") & "     " & "Savings To Checkings     " & "     " & Text2 & "o      " & Text1 & "      " & Text3, 0
        ElseIf Option2.Value = True Then
            Mainfrm.Mainlst.AddItem Format(Date, "mm/dd/yyyy") & "     " & "Checkings To Savings     " & "     " & Text2 & "o      " & Text1 & "      " & Text3, 0
        End If
...
Private Sub Form_Load()
    center Me
    DoEvents
    SetFormTopmost Transferfrm
    Transferfrm.Height = 0
    For X = 1 To 1433
        Transferfrm.Height = Transferfrm.Height + 1
        center Me
        DoEvents
        If Transferfrm.Visible <> True Then
            Transferfrm.Visible = True
        End If
    Next X
    Text1.SetFocus
End Sub
