...
Private Sub Command1_Click()
    ...
    Else
        ...
        End If
        Mainfrm.Mainlst.AddItem Format(Date, "mm/dd/yyyy") & "     " & "Deposit To Checkings     " & "     " & Text2 & "+      " & Text1 & "      " & Text3, 0
        DoEvents
...
Private Sub Form_Load()
    center Me
    DoEvents
    SetFormTopmost Dep2Chkfrm
    Dep2Chkfrm.Height = 0
    For X = 1 To 1125
        Dep2Chkfrm.Height = Dep2Chkfrm.Height + 1
        center Me
        DoEvents
        If Dep2Chkfrm.Visible <> True Then
            Dep2Chkfrm.Visible = True
        End If
    Next X
    Text1.SetFocus
End Sub
