...
Private Sub Command1_Click()
    ...
    Else
        ...
        End If
        Mainfrm.Mainlst.AddItem Format(Date, "mm/dd/yyyy") & "     " & "Withdrawal From Savings  " & "     " & Text2 & "-      " & Text1 & "      " & Text3, 0
...
Private Sub Form_Load()
    center Me
    DoEvents
    SetFormTopmost WithSavfrm
    WithSavfrm.Height = 0
    For X = 1 To 1125
        WithSavfrm.Height = WithSavfrm.Height + 1
        center Me
        DoEvents
        If WithSavfrm.Visible <> True Then
            WithSavfrm.Visible = True
        End If
    Next X
    Text1.SetFocus
End Sub
